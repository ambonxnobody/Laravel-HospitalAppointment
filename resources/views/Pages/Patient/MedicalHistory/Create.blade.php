                ...
                <div class="card-body">
                    <form action="/medicalHistory" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="surgeries" id="surgeries" class="form-control" cols="30" rows="5">{{ old('surgeries') }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label for="medication">Medication</label>
                            <textarea name="medication" id="medication" class="form-control" cols="30" rows="5">{{ old('medication') }}</textarea>
                        </div>
